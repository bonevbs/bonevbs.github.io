...
I earned my [Ph.D. in Applied Mathematics]({{ '/files/thesis_compressed.pdf' | relative_url }}) from [EPFL](https://www.epfl.ch) under [Prof. Jan S. Hesthaven](https://www.epfl.ch/labs/mcss/members/hesthaven/). I also hold degrees in Physics and Aerospace Engineering from the University of Stuttgart. My [research]({{ '/research/' | relative_url }}) spans neural operators, sparse solvers for wave problems, and discontinuous Galerkin methods for geophysical flows. See [publications]({{ '/publications/' | relative_url }}) and [software]({{ '/software/' | relative_url }}) for more.
